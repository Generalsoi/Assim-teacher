    ...
    <div className="billing">
          ...
          <div className="plan-payment-footer">
            <div className="upgrade-plan" onClick={() => setUpgradeModal(true)}>
              ...
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.41602 13.8173L14.1854 6.04785M14.1854 6.04785H6.41602M14.1854 6.04785V13.8173" stroke="#7777F9" strokeWidth="1.55699" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
      ...
      <div className="billing-invoicing-container">
        <div className="add-payment-method">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9.99984 4.1665V15.8332M4.1665 9.99984H15.8332" stroke="#667085" strokeWidth="1.67" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
