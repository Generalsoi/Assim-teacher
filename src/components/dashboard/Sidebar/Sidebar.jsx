        ...
        <ul>
          ...
          <Link to="/courses">
            <li className={handleMenu2}>
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M14.9658 25.4603C10.917 25.4603 7.45825 24.8478 7.45825 22.3953C7.45825 19.9428 10.8945 17.8078 14.9658 17.8078C19.0145 17.8078 22.4733 19.9228 22.4733 22.374C22.4733 24.8253 19.037 25.4603 14.9658 25.4603Z" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M14.9656 14.3109C17.6231 14.3109 19.7781 12.1571 19.7781 9.49963C19.7781 6.84213 17.6231 4.68713 14.9656 4.68713C12.3081 4.68713 10.1531 6.84213 10.1531 9.49963C10.1456 12.1471 12.2831 14.3021 14.9318 14.3109H14.9656Z" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M22.9529 12.9895C24.4991 12.5758 25.6391 11.1658 25.6391 9.48701C25.6391 7.73576 24.3979 6.27326 22.7454 5.93576" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M23.679 16.9305C25.8715 16.9305 27.744 18.4168 27.744 19.7443C27.744 20.5255 27.0977 21.3768 26.1177 21.6068" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M6.97974 12.9895C5.43224 12.5758 4.29224 11.1658 4.29224 9.48701C4.29224 7.73576 5.53474 6.27326 7.18599 5.93576" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M6.25226 16.9305C4.05976 16.9305 2.18726 18.4168 2.18726 19.7443C2.18726 20.5255 2.83351 21.3768 3.81476 21.6068" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
          ...
          <Link to="/schedule">
            <li className={handleMenu3}>
              <svg width="26" height="28" viewBox="0 0 26 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.86627 10.755H24.1463" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M18.5525 15.6375H18.5615" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M13.0062 15.6375H13.0152" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M7.44751 15.6375H7.45651" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M18.5525 20.495H18.5615" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M13.0062 20.495H13.0152" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M7.44751 20.495H7.45651" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M18.055 1.5V5.61375" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M7.95752 1.5V5.61375" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M18.2978 3.47399H7.7137C4.04284 3.47399 1.75 5.51891 1.75 9.27777V20.5898C1.75 24.4078 4.04284 26.5 7.7137 26.5H18.2863C21.9687 26.5 24.25 24.4433 24.25 20.6844V9.27777C24.2615 5.51891 21.9803 3.47399 18.2978 3.47399Z" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              <p>Schedule</p>
            </li>
          </Link>
